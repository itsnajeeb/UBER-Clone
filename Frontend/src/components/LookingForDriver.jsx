...
const LookingForDriver = (props) => {
    return (
        <div className='py-2'>
            ...
            <h3 className='flex justify-center text-3xl text-gray-300 '><i className="  ri-arrow-down-wide-fill" onClick={()=>{
                props.setvehicleFound(false)
            }}></i></h3>
            <h1 className='font-semibold text-xl mt-3'>Looking For a Driver</h1>
